...
model_metrics_bar(
    ...
    caption="Held-out test set (25% split, never seen during training) — transaction-level AML/structuring classification (flagged vs. clean)."
)
...
with tab1:
    ...
    with c3:
        st.metric("Model AUC (test)", f"{metrics['auc']:.3f}")
    with c4:
