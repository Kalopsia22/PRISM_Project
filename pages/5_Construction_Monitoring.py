...
from utils.styling import inject_css, page_header, PRIMARY
...
st.caption("*Near-perfect accuracy reflects the deterministic synthetic-image generator used for this demonstration, not real-world CV difficulty.")
