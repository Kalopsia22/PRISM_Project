...
disclosure(
    "Yield and appreciation figures are derived from the synthetic property/trend dataset "
    "(see Price Prediction tab for data-sourcing notes). The collaborative-filtering layer "
    "runs on simulated investor-interaction data since no real investor behavior data is used."
)
