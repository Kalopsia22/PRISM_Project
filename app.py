...
with m2:
    st.markdown(
"""**⚙️ Module deep-dives** (sidebar, below) — the price/rent, yield, AML/compliance, and
...
fig_trend.update_layout(xaxis_title="Years from now", yaxis_title="Cumulative appreciation (%)", plot_bgcolor="rgba(0,0,0,0)")
