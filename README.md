...
| Rental Yield & Investment Recommender | Risk-profile scoring + collaborative filtering (SVD), yield calibrated to Magicbricks Rental Index — surfaced in the Investor Dashboard's Rental Income view | 4 investor personas |
...
- **Module deep-dives** (sidebar, pages 3–5) — each underlying model explorable on its own,
