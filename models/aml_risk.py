...
if __name__ == "__main__":
    ...
    # persist held-out test metrics for the Streamlit page (avoid hardcoding
    # or retraining in-app)
    ...
    aml_metrics.to_csv("/home/claude/prism/data/aml_model_metrics.csv", index=False)
